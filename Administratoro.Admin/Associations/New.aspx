        ...
        <asp:Panel ID="step1" runat="server">
            ...
            <div class="x_content form-horizontal form-label-left">
                ...
                <div class="col-md-6 col-sm-6 col-xs-12 form-group has-feedback">
                    ...
                    <div class="col-md-9 col-sm-9 col-xs-12">
                        <input type="text" class="form-control has-feedback-left" id="estateAddress" runat="server" autocomplete="off" />
                        <span class="fa fa-user form-control-feedback left" aria-hidden="true"></span>
                        <asp:RequiredFieldValidator ControlToValidate="estateAddress" runat="server" ErrorMessage="Adresa proprietatății este obligatorie" CssClass="requiredField"></asp:RequiredFieldValidator>
                    </div>
                </div>
                ...
                <div class="col-md-6 col-sm-6 col-xs-12 form-group has-feedback">
                    ...
                    <div class="col-md-9 col-sm-9 col-xs-12">
                        <input type="text" class="form-control has-feedback-left" id="estateFiscalCode" runat="server" autocomplete="off">
                ...
                <div class="col-md-6 col-sm-6 col-xs-12 form-group has-feedback">
                    ...
                    <div class="bbbbbb">
                        <asp:UpdatePanel runat="server" ID="UpdatePanel1">
                            ...
                            <Triggers>
                                <asp:AsyncPostBackTrigger ControlID="estateStairs" EventName="SelectedIndexChanged" />
                            </Triggers>
                        </asp:UpdatePanel>
                    </div>
                </div>
