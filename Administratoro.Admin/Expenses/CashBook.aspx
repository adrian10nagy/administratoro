<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="CashBook.aspx.cs" Inherits="Admin.Expenses.CashBook" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    <h3 runat="server" id="mainHeader">Registru de casă</h3>
